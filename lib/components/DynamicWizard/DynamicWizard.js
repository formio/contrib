...
const DynamicWizard_form_1 = require("./DynamicWizard.form");
...
class DynamicWizard extends EditGrid {
    ...
    static savedValueTypes(schema) {
        return js_1.Utils.getComponentSavedTypes(schema) || [js_1.Utils.componentValueTypes.array];
    }
    ...
    render(children) {
        ...
        const headerTemplate = js_1.Utils.Evaluator.noeval ? templates_1.default.header : get(this.component, 'templates.header');
    ...
    switchToStep(component) {
        ...
        const arrayPath = js_1.Utils.getArrayFromComponentPath(relativePath);
    ...
    renderRow(row, rowIndex) {
        ...
        const rowTemplate = js_1.Utils.Evaluator.noeval ? templates_1.default.row : get(this.component, 'templates.row', DynamicWizard.defaultRowTemplate);
    ...
    hasButton(name, nextPage = this.getNextPage()) {
        ...
        const { previous = this.buttonSettings.showPrevious, cancel = this.buttonSettings.showCancel, next = this.buttonSettings.showNext } = this.buttonSettings;
        switch (name) {
            case 'previous':
...
DynamicWizard.editForm = DynamicWizard_form_1.default;
