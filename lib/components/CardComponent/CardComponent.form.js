...
const CardComponent_edit_data_1 = require("./editForm/CardComponent.edit.data");
const CardComponent_edit_display_1 = require("./editForm/CardComponent.edit.display");
...
function default_1(...extend) {
    const form = radioEditForm([
        { key: 'data', components: CardComponent_edit_data_1.default },
        { key: 'display', components: CardComponent_edit_display_1.default },
    ], ...extend);
