...
const SelectCardComponent_edit_data_1 = require("./editForm/SelectCardComponent.edit.data");
const SelectCardComponent_edit_display_1 = require("./editForm/SelectCardComponent.edit.display");
...
function default_1(...extend) {
    const form = radioEditForm([
        { key: 'data', components: SelectCardComponent_edit_data_1.default },
        { key: 'display', components: SelectCardComponent_edit_display_1.default },
    ], ...extend);
