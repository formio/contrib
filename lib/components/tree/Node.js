...
class Node {
    constructor(parent, { data = {}, children = [], } = {}, { checkNode = () => undefined, createComponents = () => undefined, isNew = true, removeComponents = () => undefined, parentPath = '' } = {}) {
        this.parent = parent;
        this.previousData = {};
    ...
    validateNode() {
        ...
        this.getComponents().forEach(comp => {
            ...
            valid = valid && comp.checkValidity(null, false, this.persistentData);
        });
        return valid;
    }
    addChild() {
